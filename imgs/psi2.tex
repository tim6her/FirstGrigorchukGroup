...
\coordinate [above of=ST00] (ST00*);
\coordinate [above of=ST01] (ST01*);
\coordinate [above of=ST10] (ST10*);
\coordinate [above of=ST11] (ST11*);
\end{scope}

\begin{scope}[node distance=3mm,font=\scriptsize, inner sep=1pt]
\tikzstyle{every node}=[draw=none,text=cLines]
